...
\lettrine[nindent=0em,lines=3]{E}{very}  article\ijsrasection{starting} starts with a lettrine as the first letter.
...
\begin{figure}
\includegraphics[width=\linewidth]{figures/NAME_OF_THE_FIGURE_WITHOUT_SUFFIX}
